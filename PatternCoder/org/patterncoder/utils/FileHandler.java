...
public class FileHandler
{
    ...
    {
        String result = findPatternCoderDir().getCanonicalPath() + "/" + SCHEMA_FILENAME;
        return result;
    }
    ...
    public static File findPatternCoderDir() throws FileNotFoundException
    {
        if (filePatternCoderDir == null)
        {
            ...
            filePatternCoderDir = new File(baseDir, EXTENSION_DIR_NAME + "/" + PATTERN_FILES_DIR_NAME);
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        throw new FileNotFoundException("Unable to find Patterns directory" + filePatternCoderDir);
                    }
                }
            }
        }
