...
public class PatternCoderFrame extends javax.swing.JFrame
{
    ...
    private final String STEP_DESC_DEFAULT = "Select the design pattern you wish to adopt and click <next>";
    /**
     ...
     */
    private final String WHAT_IS_PATTERNCODER = "Project patternCoder is a software tool which has been developed to support learning of design patterns and class relationships, and their implementation in Java programs. It supports the transition from the UML class diagram to a working code implementation. It works as an extension to the BlueJ IDE, on Windows, Mac OS X and Linux.\n\nHow does it work? The tool guides students through a step-by-step process in which they select a suitable pattern or class relationship (as shown in the screenshot below) and replace generic class names with names which are relevant to their project domain. patternCoder then generates Java classes in the project - these classes will compile 'out-of-the-box' and will correctly implement the relationships. The student can then explore the generated classes to understand their behaviour, and then add the necessary code to meet the specific requirements of their project.";
    private BlueJ blueJ;
    ...
    public PatternCoderFrame()
    {
        ...
        /*
         * Reacts when user changes the value of edit field edtName (class
         * name). Sets the name of the current loaded class to the input string.
         * As the listener is quite "sensibel" it may be actived even if the
         * user doesn't change the text; for that reason the setClassName-method
         * is put in try-catch
         */
    ...
    private void initComponents() {
            ...
            .addGroup(pnlInputLayout.createSequentialGroup()
                ...
                .addGroup(pnlInputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlInputLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(edtComponent, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE))
                    .addGroup(pnlInputLayout.createSequentialGroup()
                        .addComponent(lblName)
                        .addGap(18, 18, 18)
                        .addComponent(edtName, javax.swing.GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE)))
                .addGap(188, 188, 188))
        );
        ...
        txtDescription.setText("Project patternCoder is a software tool which has been developed to support learning of design patterns and class relationships, and their implementation in Java programs. It supports the transition from the UML class diagram to a working code implementation. It works as an extension to the BlueJ IDE, on Windows, Mac OS X and Linux.\n\nHow does it work? The tool guides students through a step-by-step process in which they select a suitable pattern or class relationship (as shown in the screenshot below) and replace generic class names with names which are relevant to their project domain. patternCoder then generates Java classes in the project - these classes will compile 'out-of-the-box' and will correctly implement the relationships. The student can then explore the generated classes to understand their behaviour, and then add the necessary code to meet the specific requirements of their project.");
        ...
        pnlPatternLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlPatternLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pnlPatternLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(lblDescription, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 463, Short.MAX_VALUE)))
        );
        ...
        trvPatterns.setModel(new PatternCoderTreeModel());
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(splPatternCoderMain, javax.swing.GroupLayout.DEFAULT_SIZE, 674, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(splPatternCoderMain, javax.swing.GroupLayout.DEFAULT_SIZE, 387, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    {//GEN-HEADEREND:event_trvPatternsMouseClicked
         ...
         */
        {
            ...
            edtName.setText("");
            this.currentPattern = (Pattern) selectedComponent;
            btnNext.setEnabled(true);
            txtDescription.setText(currentPattern.DESC);
        ...
        else
        {
            ...
            {
                String tempDesc = ((EnumPatterns) selectedComponent).toString();
