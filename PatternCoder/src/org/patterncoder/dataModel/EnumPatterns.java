...
{
    BASIC(java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("NAME_BASIC"), "basic", java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("DESC_BASIC")),
    CREATIONAL(java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("NAME_CREATIONAL"), "creational", java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("DESC_CREATIONAL")),
    BEHAVIOURAL(java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("NAME_BEHAVIORAL"), "behavioral", java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("DESC_BEHAVIORAL")),
    STRUCTURAL(java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("NAME_STRUCTURAL"), "structural", java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("DESC_STRUCTURAL")),
        ...
        for (File temp : dateien)
        {
            ...
            while (entries.hasMoreElements())
            {
                ...
                if (!eintrag.isDirectory())
                {
                    ...
                    //convert InputStream to String                     int number = inputStream.available();
                    ...
                    {
                        String content_XML = new String(buffer.array(), 0, buffer.position());
