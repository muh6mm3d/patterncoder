...
public class PatternCoderFrame extends javax.swing.JFrame
{
    ...
    private final String BTN_NEXT_FINISH_TEXT = java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("FINISH");
    private final String BTN_BACK_TEXT = java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("BACK");
    private final String BTN_NEXT = java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("NEXT");
    private final String STEP_DESC_DEFAULT = java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("SELECT_PATTERN"), new Object[] {BTN_NEXT});
    /**
    ...
    private final String WHAT_IS_PATTERNCODER = INFORMATION_PREFIX
            + java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("WHAT_IS_PATTERNCODER"), new Object[] {INFORMATION_POSTFIX});
    ...
    public PatternCoderFrame()
    {
        ...
        lblDescription.setText(java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("ABOUT PATTERNCODER"));
    ...
    private void startPattern()
    {
        ...
        lblStepDesc.setText(java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("FOR FURTHER INFORMATION CLICK <NEXT>"));
    ...
    private void loadComponent(PatternComponent component)
    {
        ...
        String information = java.text.MessageFormat.format(java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("Step_Number"), new Object[] {component.CLASS_ID, currentPattern.stepCount(), currentComponent.getWizardName()});
    ...
    {//GEN-HEADEREND:event_trvPatternsMouseClicked
        ...
        else
        {
            ...
            btnNext.setEnabled(false);
            currentPattern = null;
            lblDesignPattern.setText(java.util.ResourceBundle.getBundle("org/patterncoder/delegate/Bundle").getString("SELECT A PATTERN"));
        }
        btnBack.setEnabled(false);
