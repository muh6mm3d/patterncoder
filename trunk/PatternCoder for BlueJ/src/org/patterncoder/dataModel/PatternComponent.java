...
public class PatternComponent implements Comparable
{
    ...
    public void setClassName(String className)
    {
        ...
        if (!stringOkay)
        {
            do
            {
                className = JOptionPane.showInputDialog(null, java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("VALID_CLASS_NAME"), java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("VALIDNAME"));
            }
            while (!PatternCoderUtils.verifyName(className));
        }
    ...
    public void addWizardText(String[] wizardInformation) throws Exception
    {
        ...
        {
            throw new Exception(java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("WIZARD_STEP_INVALID") + this.COMP_TYPE);
        }
    }
}
