 ...
 * Examples: <br>
 *          TYPE = Observer<br>
 *          DESC = Defines an interfache that must be .... <br>
 *     className = Observer (can be changed by user)<br>
 *      template = Observer.tmpl<br>
 *          STEP = 1<br>
 *   WIZARD_DESC = Use the text field to enter a relevant name for the Observer Interface<br>
 *   WIZARD_NAME = Rename Observer<br>
 *<br>
...
public class PatternComponent implements Comparable
{
    ...
    public void setClassName(String className)
    {
        ...
        else
        {
            ...
            do
            {
                eingabe = JOptionPane.showInputDialog(null, java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("VALID_CLASS_NAME"), java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("VALIDNAME"));
            }
