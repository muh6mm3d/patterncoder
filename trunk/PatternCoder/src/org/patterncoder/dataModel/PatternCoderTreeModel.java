...
public class PatternCoderTreeModel implements TreeModel
{
     ...
     * Root of tree
     */
    public final String ROOT = java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("PATTERNCODER");
    ...
    {
        throw new UnsupportedOperationException(java.util.ResourceBundle.getBundle("org/patterncoder/dataModel/Bundle").getString("NOT_SUPPORTED"));
    }
